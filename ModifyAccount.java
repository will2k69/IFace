        ...
        while (true) {
            ...
            if (opcao.equals("1")) {
                ...
                while (true) {
                    ...
                    for (UserIface uIface: ifm.usersList.values()) {
                    ...
                    if (nice) {
                        ifm.usersList.get(this.login).setName(n);
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ...
            if (opcao.equals("2")) {
                ...
                while (true) {
                    ...
                    if (nice) {
                        ifm.usersList.get(this.login).setLogin(l);
                        ifm.usersList.put(l, ifm.usersList.get(this.login));
            ...
            if (opcao.equals("3")) {
                ...
                while (true) {
                    ...
                    if (ifm.usersList.get(this.login).getPass().equals(s)) {
                        System.out.println("\n=========================================");
                    ...
                    if (nice) {
                        ifm.usersList.get(this.login).setPass(s);
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ...
            try {
                if (opcao.equals("4") || opcao.equals("5") || opcao.equals("8")) {
                    ...
                    switch(opcao) {
                        case "4":
                        ifm.usersList.get(this.login).dataLongInt.put("Celular (1)", new UserData<Long>(Long.parseLong(s), "Celular (1)"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\tNúmero (1) adicionado com sucesso!");
                        break;
                        
                        case "5":
                        ifm.usersList.get(this.login).dataLongInt.put("Celular (2)", new UserData<Long>(Long.parseLong(s), "Celular (2)"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\tNúmero (2) adicionado com sucesso!");
                        break;

                        case "8":
                        ifm.usersList.get(this.login).dataLongInt.put("Idade", new UserData<Long>(Long.parseLong(s), "Idade"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                    ...
                    switch(opcao) {
                        case "6":
                        ifm.usersList.get(this.login).dataStr.put("Endereço", new UserData<String>(s, "Endereço"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\tSeu endereço foi adicionado com sucesso!");
                        break;

                        case "7":
                        ifm.usersList.get(this.login).dataStr.put("Data de nascimento", new UserData<String>(s, "Data de nascimento"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\tData de nascimento adicionada com sucesso!");
                        break;

                        case "9":
                        ifm.usersList.get(this.login).dataStr.put("Signo", new UserData<String>(s, "Signo"));
                        System.out.println("\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
